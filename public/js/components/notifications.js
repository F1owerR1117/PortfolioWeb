...
var ComponentsNotifications = {
  renderNotifications: async function() {
    ...
    try {
      ...
      var labels = { reply: '回复了你的评论', comment: '评论了你的帖子', like: '点赞了你的帖子', dislike: '点踩了你的帖子', sticky: '帖子被置顶', featured: '帖子被设为精华', locked: '帖子被锁定', post_deleted: '帖子被删除', friend_request: '请求添加好友', friend_approved: '通过了你的好友申请', message: '发送了私信', bookmark: '收藏了你的帖子', playlist_collect: '收藏了你的歌单', banned: '你已被禁言', job_approved: '身份申请已通过', job_rejected: '身份申请未通过' };
      var icons = { reply: '💬', comment: '💬', like: '👍', dislike: '👎', sticky: '📌', featured: '⭐', locked: '🔒', post_deleted: '🗑️', friend_request: '👥', friend_approved: '✅', message: '✉️', bookmark: '🔖', playlist_collect: '📋', banned: '🚫', job_approved: '✅', job_rejected: '❌' };
